Thia repo is created as a part of code for tomorrow assignment. Tech stack - Node, express, typescript, prisma (orm), postgres.
Assumption - One user can have a single plan only. And, every plan would have some pre-set monthly quota. The logic will consider 
